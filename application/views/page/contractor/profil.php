            ...
            <div class="col-md-5 text-center pt-4">
              <div class="profil mb-3">
                <?php if($user['profile']): ?>
                  ...
                  <?php endif; ?>
                <div class="container">
                  <p class="lead mt-3 mb-0">Nama Kontraktor</p>
                  <p class="text-muted">username</p>
                </div>
              </div>
              <div>
                <a type="button" class="btn btn-sm btn-info mt-2" href="<?php echo base_url('kontraktor/profil/edit-profil'); ?>">Edit Profil</a>
              </div>
            </div>  
